...
<div class="contrainer py-1">
    ...
    <div class="row p-5 " style="background-color: #e3f2fd;">
        <div class="py-2 col-2 bg-light ">
    ...
    <div class= 'row p-5 text-center' style="background-color: #e3f2fd;" >
        ...
        <div class="p-4 col-2 bg-light">
            <h5>
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-signpost-split" viewBox="0 0 16 16">
            <path d="M7 7V1.414a1 1 0 0 1 2 0V2h5a1 1 0 0 1 .8.4l.975 1.3a.5.5 0 0 1 0 .6L14.8 5.6a1 1 0 0 1-.8.4H9v10H7v-5H2a1 1 0 0 1-.8-.4L.225 9.3a.5.5 0 0 1 0-.6L1.2 7.4A1 1 0 0 1 2 7h5zm1 3V8H2l-.75 1L2 10h6zm0-5h6l.75-1L14 3H8v2z"/>
            </svg> <br>
            LARGEST TRANSPOTATION <br>
            NETWORK IN BANGLADESH </h5>
        </div>
        <div class="p-4 col-2 bg-light">
            <h5><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-truck-front" viewBox="0 0 16 16">
                ...
                </svg> <br>COMFORT ON BOARD
                </h5>
        </div>
        <div class="p-4 col-2 bg-light">
            <H5><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-stopwatch" viewBox="0 0 16 16">
            <path d="M8.5 5.6a.5.5 0 1 0-1 0v2.9h-3a.5.5 0 0 0 0 1H8a.5.5 0 0 0 .5-.5V5.6z"/>
            <path d="M6.5 1A.5.5 0 0 1 7 .5h2a.5.5 0 0 1 0 1v.57c1.36.196 2.594.78 3.584 1.64a.715.715 0 0 1 .012-.013l.354-.354-.354-.353a.5.5 0 0 1 .707-.708l1.414 1.415a.5.5 0 1 1-.707.707l-.353-.354-.354.354a.512.512 0 0 1-.013.012A7 7 0 1 1 7 2.071V1.5a.5.5 0 0 1-.5-.5zM8 3a6 6 0 1 0 .001 12A6 6 0 0 0 8 3z"/>
            </svg><br> 
            BUS ARRIVE <br> ON TIME</H5>
        </div>
        <div class="p-4 col-2 bg-light">
            <h5><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-cup-straw" viewBox="0 0 16 16">
            ...
            </svg><br>TRAVEL WITH <br> ENVIRONMENTALLY-FRIENDLY
