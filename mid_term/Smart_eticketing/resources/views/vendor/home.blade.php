...
<div class="contrainer py-1">
    ...
    <div class= 'row p-5 text-center' style="background-color: #e3f2fd;" >
        ...
        <div class="p-4 col-2 bg-light">
            <h5>
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class=" pb-2 bi bi-signpost-split" viewBox="0 0 16 16">
        ...
        <div class="p-4 col-2 bg-light">
            <h5><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class=" pb-2 bi bi-truck-front" viewBox="0 0 16 16">
        ...
        <div class="p-4 col-2 bg-light">
            <H5><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="pb-2 bi bi-stopwatch" viewBox="0 0 16 16">
        ...
        <div class="p-4 col-2 bg-light">
            <h5><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class=" pb-2 bi bi-cup-straw" viewBox="0 0 16 16">
            ...
            </svg><br> ENVIRONMENTALLY-FRIENDLY
